...
cd /d "%~dp0"
powershell -NoProfile -ExecutionPolicy Bypass -Command "Start-Process PowerShell -ArgumentList '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', '.\Start-WindowsOptimizer.ps1' -WorkingDirectory '%CD%' -Verb RunAs"
